...
function PFR() {
  ...
  const calculateRequiredVolume = (e) => {
    ...
    try {
      ...
      if (n === 1) {
        // First order reaction
        volume = F * Math.log(1 / (1 - X)) / k
      } else {
        // Other reaction orders
        volume = F * (Math.pow(1 - X, 1 - n) - 1) / ((n - 1) * k * Math.pow(C0, n - 1))
      }
  ...
  const renderConversionCalculator = () => (
    <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
      <h2 className="text-2xl font-bold text-blue-900 mb-6">Calculate PFR Conversion</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-64 bg-blue-900 text-white p-4 hidden md:block fixed h-screen overflow-y-auto">
        ...
        <h2 className="text-xl font-bold mb-4">PFR</h2>
        ...
        <header className="bg-blue-900 text-white p-6 shadow-lg md:hidden">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold">PFR Calculator</h1>
            </div>
